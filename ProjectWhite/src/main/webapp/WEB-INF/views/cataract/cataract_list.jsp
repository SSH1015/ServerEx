                            ...
                            <table class="table table-hover" width="1100">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center;">백내장</th>
                                ...
                                <tbody>
                                    <c:forEach var="row" items="${list}">
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;"><img src="${pageContext.request.contextPath}/resources/cataract/${row.c_img}" alt="사진" style="width: 100px; height: 100px;"></td>
                                            ...
                                            <!--<td><fmt:formatDate value="${row.c_updatedate}" pattern="yyyy-MM-dd HH:mm:ss"/><td>-->
                                             <td style="vertical-align: middle;">${row.c_updatedate} </td> 
